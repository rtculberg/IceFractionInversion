...
function [x_keep, L_keep, count, reflectivity] = mcmc_gauss_fresnel(data,x0,xstep,xbnds,sigma,Niter,coefficients,depth,filename)
    ...
    A_tot = 2*del_az*sqrt((h*lambda)/2);    % illuminated area
